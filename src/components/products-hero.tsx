      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center flex flex-col items-center">
        ...
        >
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#3C85C6]/20 to-[#00D4FF]/20 backdrop-blur-sm border border-[#3C85C6]/30 rounded-full px-6 py-3 mb-8">
            <Package className="h-5 w-5 text-[#3C85C6]" />
            <span className="text-white font-medium text-center">Software y Soluciones Tecnológicas</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
            Nuestros <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3C85C6] to-[#00D4FF]">Productos</span>
          </h1>
          
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Soluciones de software de clase mundial para transformar tu negocio. 
            Trabajamos con las marcas líderes en tecnología empresarial.
          </p>
        </motion.div>
        ...
        >
          ...
          <span className="text-sm text-gray-400 mt-2">Explora nuestros productos</span>
        </motion.div>
      </div>
    </section>
  )
